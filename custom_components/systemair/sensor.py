...
SYSTEMAIR_SENSORS = [
    # (Translation_Key, Register, Device_Class, Unit, Scale, Icon, State_Class)
   ...
   # ("extract_temp", 12105, SensorDeviceClass.TEMPERATURE, UnitOfTemperature.CELSIUS, 0.1, "mdi:home-thermometer", SensorStateClass.MEASUREMENT), #Accessory
    ...
    ("rel_moisture", 12135, SensorDeviceClass.HUMIDITY, "%", 1.0, None, SensorStateClass.MEASUREMENT),
    ...
    ("heat_recovery_efficiency", 14102, SensorDeviceClass.POWER_FACTOR, "%", 1.0, "mdi:percent", SensorStateClass.MEASUREMENT),
...
class SystemairSensor(SensorEntity):
    ...
    async def async_update(self):
        try:
            ...
            # 2. Summer/Winter (Translation slugs)
            ...
            _LOGGER.error("SaveVSR: Update failed for %s: %s", self._attr_translation_key, e)