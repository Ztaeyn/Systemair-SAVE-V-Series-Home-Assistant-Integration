...
class SaveVSRGenericSensor(SensorEntity):
    ...
    def __init__(self, hub, model, slave, name, register, device_class, unit, scale, icon, state_class=None):
        ...
        self._attr_unique_id = f"{DOMAIN}_{slave}_sensor_{register}"
        self._state = None
    ...
    async def async_update(self):
        try:
            # 1. Mode Time Remaining (32-bit Input)
            ...
            # 2. Current Fan Mode (Logic based on 1160 and 1130)
            ...
            # 3. Filter Time Remaining (32-bit Holding)
